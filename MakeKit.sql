...
CREATE TABLE IF NOT EXISTS `makekit`.`userinfo` (
  ...
  `userImage` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `makekit`.`orderdetail` (
  ...
  `orderReviewInsertDate` DATE NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `makekit`.`register` (
  ...
  INDEX `fk_register_product1_idx` (`product_productNo` ASC) VISIBLE,
